...
tar -czvf local-llm-studio-offline.tar.gz offline_packages/ models/ .env .env.example deploy-offline.sh start-server.sh README.md requirements.txt SUPPORTED_MODELS.md
